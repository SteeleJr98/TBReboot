 ...
 public class TBRecipes
 {
   public static void setup() {
     ...
     ShapedOreRecipe eAr = new ShapedOreRecipe(new ItemStack(TBBlocks.eldritchArk, 5, 0), new Object[] { "@#@", "###", "@#@", Character.valueOf('@'), "nuggetGold", Character.valueOf('#'), "obsidian" });
     ...
     ShapedOreRecipe iGw = new ShapedOreRecipe(new ItemStack(TBBlocks.ironGreatwood, 5, 0), new Object[] { "@#@", "###", "@#@", Character.valueOf('@'), "nuggetIron", Character.valueOf('#'), new ItemStack(ConfigBlocks.blockWoodenDevice, 1, 6) });
     ...
     GameRegistry.addRecipe((IRecipe)qBl);
     GameRegistry.addRecipe((IRecipe)qSi);
     GameRegistry.addRecipe((IRecipe)qBr);
     GameRegistry.addRecipe((IRecipe)smB);
     GameRegistry.addRecipe((IRecipe)tnU);
     GameRegistry.addRecipe((IRecipe)tnI);
     GameRegistry.addRecipe((IRecipe)tiB);
     GameRegistry.addRecipe((IRecipe)tnB);
     GameRegistry.addRecipe((IRecipe)eAr);
     GameRegistry.addRecipe((IRecipe)iGw);
     GameRegistry.addRecipe((IRecipe)biP);
     GameRegistry.addRecipe((IRecipe)spP);
     GameRegistry.addRecipe((IRecipe)enP);
     int i;
     for (i = 0; i < BlockHalfSlab.parents.length; i++) {
 
 
       
       ShapedOreRecipe slabRec = new ShapedOreRecipe(new ItemStack(TBBlocks.genericSlab, 6, i), new Object[] { "###", Character.valueOf('#'), BlockHalfSlab.parents[i] });
       
       slabs.add(slabRec);
       GameRegistry.addRecipe((IRecipe)slabRec);
     } 
     ...
     for (i = 0; i < 8; i++) {
       ...
       ShapedOreRecipe slabRec = new ShapedOreRecipe(new ItemStack(TBBlocks.crystalSlab, 6, i), new Object[] { "###", Character.valueOf('#'), new ItemStack(TBBlocks.crystalBlock, 1, i) });
       
       slabs.add(slabRec);
       GameRegistry.addRecipe((IRecipe)slabRec);
     } 
     
     ((BlockTBPlant)BlockTBPlant.class.cast(TBBlocks.plax)).dropItem = new ItemStack(Items.string, 3, 0);
     ...
     ((BlockTBPlant)BlockTBPlant.class.cast(TBBlocks.lucrite)).dropItem = new ItemStack(Items.gold_nugget, 3, 0);
     ...
     ((BlockTBPlant)BlockTBPlant.class.cast(TBBlocks.lazullia)).dropItem = new ItemStack(Items.dye, 1, 4);
     ...
     ((BlockTBPlant)BlockTBPlant.class.cast(TBBlocks.glieonia)).dropItem = new ItemStack(Items.glowstone_dust, 2, 0);
