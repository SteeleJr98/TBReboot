   ...
   implements ICrafting
 {
   ...
   public GuiThaumicAnvil(InventoryPlayer p_i1073_1_, World p_i1073_2_, int p_i1073_3_, int p_i1073_4_, int p_i1073_5_) {
     super((Container)new ContainerThaumicAnvil(p_i1073_1_, p_i1073_2_, p_i1073_3_, p_i1073_4_, p_i1073_5_, (EntityPlayer)(Minecraft.getMinecraft()).thePlayer));
   ...
   private void func_147090_g() {
     ...
     this.mc.thePlayer.sendQueue.addToSendQueue((Packet)new C17PacketCustomPayload("MC|ItemName", s.getBytes(Charsets.UTF_8)));
   }
   ...
   protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
     ...
     drawTexturedModalRect(k + 59, l + 20, 0, this.ySize + (this.field_147092_v.getSlot(0).getHasStack() ? 0 : 16), 110, 16);
     ...
     {
       drawTexturedModalRect(k + 99, l + 45, this.xSize, 0, 28, 21);
     }
   }
