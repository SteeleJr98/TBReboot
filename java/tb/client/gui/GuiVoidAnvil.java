   ...
   implements ICrafting
 {
   ...
   public GuiVoidAnvil(InventoryPlayer p_i1073_1_, World p_i1073_2_, int p_i1073_3_, int p_i1073_4_, int p_i1073_5_) {
     super((Container)new ContainerVoidAnvil(p_i1073_1_, p_i1073_2_, p_i1073_3_, p_i1073_4_, p_i1073_5_, (EntityPlayer)(Minecraft.getMinecraft()).thePlayer));
