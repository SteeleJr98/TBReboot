...
import tb.init.TBDimensionRegistry;
...
public class TBCore {
	...
	public void preInit(FMLPreInitializationEvent event) throws IOException {
		...
		if (dimTesting && isDev) {
			FileUtils.deleteDirectory(new File("C:\\Users\\Steele\\Desktop\\Coding\\1.7.10 modding\\TBTesting\\eclipse\\saves\\dim test 1\\DIM17\\"));
			saveFolder = new File(event.getModConfigurationDirectory(), "\\..\\saves");
			DummySteele.SpamDebugMessage(6, saveFolder.toString());
		}
