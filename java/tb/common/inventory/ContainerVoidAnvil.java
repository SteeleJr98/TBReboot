...
public class ContainerVoidAnvil extends ContainerRepair {
	...
	private IInventory inputSlots = (IInventory)new InventoryBasic("Repair", true, 2) {
		public void markDirty() {
			super.markDirty();
			ContainerVoidAnvil.this.onCraftMatrixChanged((IInventory)this);
		}
	};
	...
	public ContainerVoidAnvil(InventoryPlayer inv, World w, int x, int y, int z, EntityPlayer p) {
		...
		addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
			...
			public boolean canTakeStack(EntityPlayer p_82869_1_) {
				return ((p_82869_1_.capabilities.isCreativeMode || p_82869_1_.experienceLevel >= ContainerVoidAnvil.this.maximumCost) && ContainerVoidAnvil.this.maximumCost > 0 && getHasStack());
			}
			...
			public void onPickupFromSlot(EntityPlayer p_82870_1_, ItemStack p_82870_2_) {
				...
				float breakChance = ForgeHooks.onAnvilRepair(p_82870_1_, p_82870_2_, ContainerVoidAnvil.this.inputSlots.getStackInSlot(0), ContainerVoidAnvil.this.inputSlots.getStackInSlot(1));
				...
				if (ContainerVoidAnvil.this.stackSizeToBeUsedInRepair > 0) {
					...
					if (itemstack1 != null && itemstack1.stackSize > ContainerVoidAnvil.this.stackSizeToBeUsedInRepair) {
				...
				if (!p_82870_1_.capabilities.isCreativeMode && !wrld.isRemote && wrld.getBlock(ax, ay, az) == TBBlocks.voidAnvil && p_82870_1_.getRNG().nextFloat() < breakChance) {
	...
	public boolean canInteractWith(EntityPlayer p_75145_1_) {
		return (this.w.getBlock(this.x, this.y, this.z) != TBBlocks.voidAnvil) ? false : ((p_75145_1_.getDistanceSq(this.x + 0.5D, this.y + 0.5D, this.z + 0.5D) <= 64.0D));
	}
