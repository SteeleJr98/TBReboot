 ...
 public class ContainerThaumicAnvil
   extends ContainerRepair
 {
   ...
   private IInventory inputSlots = (IInventory)new InventoryBasic("Repair", true, 2)
     {
       ...
       {
         super.markDirty();
         ContainerThaumicAnvil.this.onCraftMatrixChanged((IInventory)this);
       }
     };
   ...
   public ContainerThaumicAnvil(InventoryPlayer inv, World w, int x, int y, int z, EntityPlayer p) {
     ...
     addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47)
         {
           ...
           public boolean canTakeStack(EntityPlayer p_82869_1_) {
             return ((p_82869_1_.capabilities.isCreativeMode || p_82869_1_.experienceLevel >= ContainerThaumicAnvil.this.maximumCost) && ContainerThaumicAnvil.this.maximumCost > 0 && getHasStack());
           }
           ...
           public void onPickupFromSlot(EntityPlayer p_82870_1_, ItemStack p_82870_2_) {
             ...
             float breakChance = ForgeHooks.onAnvilRepair(p_82870_1_, p_82870_2_, ContainerThaumicAnvil.this.inputSlots.getStackInSlot(0), ContainerThaumicAnvil.this.inputSlots.getStackInSlot(1)) / 3.0F;
     ...
     for (i = 0; i < 3; i++) {
       ...
       for (int j = 0; j < 9; j++)
       {
         addSlotToContainer(new Slot((IInventory)inv, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
       }
     } 
     
     for (i = 0; i < 9; i++)
     {
       addSlotToContainer(new Slot((IInventory)inv, i, 8 + i * 18, 142));
     }
   }
   ...
   public void updateRepairOutput() {
     ...
     if (itemstack == null) {
       ...
       if (itemstack2 != null) {
         ...
         if (!ForgeHooks.onAnvilChange(this, itemstack, itemstack2, this.outputSlot, this.repairedItemName, k2))
           return;  flag = (itemstack2.getItem() == Items.enchanted_book && Items.enchanted_book.func_92110_g(itemstack2).tagCount() > 0);
         
         if (itemstack1.isItemStackDamageable() && itemstack1.getItem().getIsRepairable(itemstack, itemstack2)) {
           
           int m = Math.min(itemstack1.getItemDamageForDisplay(), itemstack1.getMaxDamage() / 4);
           ...
           int l;
           for (l = 0; m > 0 && l < itemstack2.stackSize; l++) {
             
             int i1 = itemstack1.getItemDamageForDisplay() - m;
             itemstack1.setItemDamage(i1);
             i += Math.max(1, m / 100) + map.size();
             m = Math.min(itemstack1.getItemDamageForDisplay(), itemstack1.getMaxDamage() / 4);
           } 
           ...
           if (itemstack1.isItemStackDamageable() && !flag) {
             ...
             int m = itemstack.getMaxDamage() - itemstack.getItemDamageForDisplay();
             int l = itemstack2.getMaxDamage() - itemstack2.getItemDamageForDisplay();
       ...
       if (itemstack1 != null) {
         ...
         int l = itemstack1.getRepairCost();
   ...
   public void addCraftingToCrafters(ICrafting p_75132_1_) {
     ...
     p_75132_1_.sendProgressBarUpdate((Container)this, 0, this.maximumCost);
   }
   ...
   public boolean canInteractWith(EntityPlayer p_75145_1_) {
     return (this.w.getBlock(this.x, this.y, this.z) != TBBlocks.thaumicAnvil) ? false : ((p_75145_1_.getDistanceSq(this.x + 0.5D, this.y + 0.5D, this.z + 0.5D) <= 64.0D));
   }
   ...
   public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
     ...
     if (slot != null && slot.getHasStack()) {
       ...
       if (p_82846_2_ == 2) {
         ...
         if (p_82846_2_ >= 3 && p_82846_2_ < 39 && !mergeItemStack(itemstack1, 0, 2, false))
         {
           return null;
         }
       }
