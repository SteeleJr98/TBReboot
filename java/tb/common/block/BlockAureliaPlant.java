...
public class BlockAureliaPlant extends Block {
	...
	public BlockAureliaPlant() {
		...
		setBlockBounds(0.25F, 0.0F, 0.25F, 0.75F, 0.85F, 0.75F);
		setLightLevel(0.5F);
	}
	...
	public void registerBlockIcons(IIconRegister reg) {
		icons[0] = reg.registerIcon(this.textureName + "closed");
		icons[1] = reg.registerIcon(this.textureName + "open");
	}
	...
	public static boolean canGrowOn(World w, int x, int y, int z) {
		return (!w.isAirBlock(x, y, z) && (w.getBlock(x, y, z).isReplaceableOreGen(w, x, y, z, (Block)Blocks.grass) || w.getBlock(x, y, z).isReplaceableOreGen(w, x, y, z, Blocks.dirt)));
	}
}
