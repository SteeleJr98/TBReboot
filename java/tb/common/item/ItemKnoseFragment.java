 ...
 public class ItemKnoseFragment
   extends Item
 {
   public static final String[] names = new String[] { "air", "fire", "aqua", "terra", "order", "entropy", "mixed", "tainted" };
   ...
   public static final AspectList[] addedAspects = new AspectList[] {
       lst(8, new Aspect[] { Aspect.AIR
         }), lst(8, new Aspect[] { Aspect.FIRE
         }), lst(8, new Aspect[] { Aspect.WATER
         }), lst(8, new Aspect[] { Aspect.EARTH
         }), lst(8, new Aspect[] { Aspect.ORDER
         }), lst(8, new Aspect[] { Aspect.ENTROPY
         }), lst(2, new Aspect[] { Aspect.FIRE, Aspect.WATER, Aspect.EARTH, Aspect.AIR, Aspect.ORDER, Aspect.ENTROPY })
     };
   ...
   public void registerIcons(IIconRegister reg) {
     for (int i = 0; i < names.length; i++) {
       icons[i] = reg.registerIcon(this.iconString + names[i] + "Fragment");
     }
   }
   ...
   public ItemStack onItemRightClick(ItemStack stk, World w, EntityPlayer player) {
     ...
     if (!player.worldObj.isRemote)
       if (meta < 7) {
         ...
         int overhaulAddedAspects = 0; int i;
         for (i = 0; i < Aspect.getCompoundAspects().size(); i++) {
         ...
         for (i = 0; i < overhaulAddedAspects; i++) {
