...
public class DummySteeleTempGui extends GuiContainer {
	
	public List<DummySteeleTempGuiElement> elements = new ArrayList<DummySteeleTempGuiElement>();
	...
	public DummySteeleTempGui(Container container) {
		super(container);
	}
	
	public DummySteeleTempGui(Container container, TileEntity TE) {
		this(container);
		tile = TE;
	}
	...
	protected void drawGuiContainerBackgroundLayer(float f1, int i1, int i2) {
		...
		{
			DummySteeleTempGuiElement element = elements.get(i);
